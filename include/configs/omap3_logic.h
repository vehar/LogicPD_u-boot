...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"sdboot=setenv bootargs display=${display} console=${consoledev},${baudrate} root=${sdroot} rw ${otherbootargs}; mmcinit; fatload mmc0 ${loadaddr} ${kernelimage}; bootm ${loadaddr}\0" \
